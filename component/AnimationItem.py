...
class AnimationItem:
    def __init__(self, frame, item_id, item_name, progress=0, exported=False, image=None):
        self.frame = ctk.CTkFrame(frame, fg_color="#333333", border_width=1, corner_radius=10,border_color="black")
        ...
        self.export_button = ctk.CTkButton(self.frame, text="Birleştir", width=10, height=10, fg_color="transparent")
        self.export_status_label = ctk.CTkLabel(self.frame, text="Not Exported" if not exported else "Exported",
        ...
        self.export_button.grid(row=1, column=0, pady=2, padx=1, sticky="ew")
        self.export_status_label.grid(row=1, column=6, pady=2, padx=1, sticky="ew")

        self.upload_button.grid(row=2, column=0, pady=2, padx=1, sticky="ew")
        self.upload_progress_label.grid(row=2, column=6, pady=2, padx=1, sticky="ew")
        self.upload_link_button.grid(row=2, column=9, pady=2, padx=1, sticky="ew")
    ...
    def update_export_status(self, exported):
        self.export_status_label.configure(text="Not Exported" if not exported else "Exported",
                                           text_color="Red" if not exported else "Green")
    ...
    def destroy(self):
        ...
        self.export_status_label.destroy()
